...
describe('UserProfileCardLeicht', () => {
    ...
    test('disables delete button if user registered within 24 hours', () => {
        const recentUserProfile = { ...mockUserProfile, registrationDate: new Date(Date.now() - 12 * 60 * 60 * 1000) };
        render(
            <UserProfileCardLeicht
