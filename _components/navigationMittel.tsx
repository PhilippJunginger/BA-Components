...
import { RequestDto, RequestType } from '../leicht/navigationLeicht';
...
interface NavigationMittelProps {
    navItems: NavItem[];
...
export default function NavigationMittel(props: NavigationMittelProps) {
    const { navItems, currentRequest, handleRequestDeletion } = props;
