...
describe('UserProfileCardLeicht', () => {
    ...
    it.skip('disables delete button when user is registered for more than 24 hours', () => {
        render(
            <UserProfileCardLeicht
                userProfile={mockUserProfile}
                setUserProfile={mockSetUserProfile}
    ...
    it.skip('enables delete button when user is registered for less than 24 hours', () => {
