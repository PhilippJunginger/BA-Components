...
describe('UserProfileCardSchwer', () => {
    ...
    test('expands additional information when expand button is clicked', async () => {
        ...
        expect(await screen.findByText('Show Profile Page')).toBeInTheDocument();
        expect(
    ...
    test('navigates to profile page when "Show Profile Page" button is clicked', async () => {
        ...
        const showProfilePageButton = await screen.findByText('Show Profile Page');
